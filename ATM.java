...
public class ATM {
    ...
    public static void main(String[] args) {
        ...
        checkBalanceButton.addActionListener(e -> updateBalanceLabel(balanceLabel, balance));
        depositButton.addActionListener(e -> performTransaction(amountField, balanceLabel, true));
        withdrawButton.addActionListener(e -> performTransaction(amountField, balanceLabel, false));
